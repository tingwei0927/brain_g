...
def for_video01(readvideo):
    ...
    mp_holistic = mp.solutions.holistic
        ...
        #輸入的影片
    vvv = readvideo
    path = "E://things/master/DIH/DIH/show2/"+vvv+"/"+vvv+".mp4"
    new_path = "E://things/master/DIH/DIH/show2/"+vvv+"/test/"+vvv+"-score.avi"
    score_path = "E://things/master/DIH/DIH/show2/"+ vvv+"/test/"+vvv+"-score.png"
    ...
    frame_count = 0
    tall=[]
    output_folder = "E://things/master/DIH/DIH/show2/"+vvv+'/test/keypoints-'+ video_name.split("/")[2].split(".")[0]  # 設定儲存關鍵點檔案的資料夾路徑
    output_folder2 = "E://things/master/DIH/DIH/show2/"+vvv+'/test/keypoints-3d-'+ video_name.split("/")[2].split(".")[0]
