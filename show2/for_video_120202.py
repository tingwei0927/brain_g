...
def for_video12(readvideo):
    ...
    score_path = "./"+ vvv+"/test/"+vvv+"-ㄉㄢscore.png"
...
#     elapsed_time = round(elapsed_time,2)
    ...
    #開始算成績
    howmany, where = stad_count(vvv,dist_all3) #算總共做了幾次
    print("times:",howmany)
    print("where:",where)
    print("ffff:",len(sa_F))
    print("hhhh:",len(sa_H))
...
#             get_H.append(sa_H[i])
    ...
    get_F=catch2_2(where,sa_F)
    get_H=catch2_2(where,sa_H)
    #print("get_F:",get_F)
    #print("get_H:",get_H)
